...
function promedioResultadosTest(resultadosTest) {
  ...
  // Tu código:
  let suma = 0;     
  resultadosTest.forEach (function(numero){
      suma += numero;
  });
...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  const mayor18 = arreglo.filter(element => element > 18)
